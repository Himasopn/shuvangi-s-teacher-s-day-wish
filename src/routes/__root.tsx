...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A quiet Teachers' Day tribute for Shuvangi Ma'am, wrapped in cherry blossoms." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Happy Teachers' Day | Shuvangi Ma'am" },
      { property: "og:description", content: "A quiet Teachers' Day tribute for Shuvangi Ma'am, wrapped in cherry blossoms." },
